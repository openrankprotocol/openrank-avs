...
abstract contract DeployRxpBase is DeployTestUtils {
    using BN254 for *;
    ...
    function _deployContracts() internal {
        ...
        serviceManagerImplementation = newServiceManagerImplementation();
    ...
    function newServiceManagerImplementation() public virtual returns (IServiceManager);
    function initializeServiceManager() public virtual;
