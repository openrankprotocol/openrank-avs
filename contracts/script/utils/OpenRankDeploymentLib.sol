...
import {CoreDeployLib, CoreDeploymentParsingLib} from "./CoreDeploymentLib.sol";
import {Strings} from "@openzeppelin/contracts/utils/Strings.sol";

library OpenRankDeploymentLib {
    using stdJson for *;
    using Strings for *;
    ...
    struct DeploymentData {
        address openRankServiceManager;
    ...
    function deployContracts(
...

        {
            ...
            result.openRankServiceManager = UpgradeableProxyLib.setUpEmptyProxy(
                proxyAdmin
            );
    ...
    function deployAndUpgradeStakeRegistryImpl(
        ...
        bytes memory upgradeCall = abi.encodeCall(
            ...
            (deployment.openRankServiceManager, 0, quorum)
        );
    ...
    function deployAndUpgradeServiceManagerImpl(
        ...
        address openRankServiceManager = deployment.openRankServiceManager;
        address openRankServiceManagerImpl = address(
            new OpenRankServiceManager(
                core.avsDirectory,
                deployment.stakeRegistry,
        ...
        bytes memory upgradeCall = abi.encodeCall(
            OpenRankServiceManager.initialize,
            (owner, rewardsInitiator)
        );

        UpgradeableProxyLib.upgradeAndCall(
            openRankServiceManager,
            openRankServiceManagerImpl,
            upgradeCall
        );
    }
    ...
    function readDeploymentJson(
        ...
        require(
            vm.exists(fileName),
            "OpenRankDeployment: Deployment file does not exist"
        );
        ...
        data.openRankServiceManager = json.readAddress(
            ".addresses.openRankServiceManager"
        );
    ...
    function writeDeploymentJson(
        ...
        address proxyAdmin = address(
            UpgradeableProxyLib.getProxyAdmin(data.openRankServiceManager)
        );
    ...
    function readDeploymentConfigValues(
        ...
        require(
            ...
            "OpenRankDeployment: Deployment Config file does not exist"
        );
    ...
    function _generateContractsJson(
        ...
        return
            string.concat(
                ...
                '","openRankServiceManager":"',
                data.openRankServiceManager.toHexString(),
                '","openRankServiceManagerImpl":"',
                data.openRankServiceManager.getImplementation().toHexString(),
                '","stakeRegistry":"',
